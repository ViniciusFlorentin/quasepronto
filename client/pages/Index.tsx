...
const ServiceCard = ({
  ...
  <div
    className={`bg-eclipse-dark p-8 md:p-16 rounded-2xl md:rounded-3xl flex flex-col gap-6 ${className}`}
  >
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="flex gap-2">
          {socials.map((social, index) => (
            <div
              key={index}
              className="w-8 h-8 bg-eclipse-dark rounded-lg"
            ></div>
          ))}
        </div>
      </div>
      ...
      <section className="bg-eclipse-dark relative overflow-hidden min-h-screen">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 md:px-24 py-8 h-28">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link
              to="/"
              className="text-eclipse-white font-funnel text-lg hover:text-eclipse-purple-light transition-colors"
            >
              Inicio
            </Link>
            <Link
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row justify-between items-end gap-8 mb-20">
              <h2 className="text-eclipse-white font-funnel text-4xl md:text-6xl font-normal leading-tight">
                Alcance que se{" "}
                <span className="text-eclipse-purple-light">
                  traduz em resultado
                </span>
              </h2>
              <p className="text-eclipse-gray font-funnel text-lg md:text-xl max-w-md">
                ...
                e refletem nosso alcance de forma transparente.
              </p>
            </div>
          ...
          <div className="relative">
            ...
            <button className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-eclipse-light-purple rounded-full flex items-center justify-center hover:bg-opacity-80 transition-all">
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                className="text-eclipse-dark rotate-180"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M3 12C3 12.5523 3.4477 13 4 13H20C20.5523 13 21 12.5523 21 12C21 11.4477 20.5523 11 20 11H4C3.4477 11 3 11.4477 3 12Z"
                  fill="currentColor"
                />
                <path
          ...
          >
            <div className="flex flex-col items-start gap-12 max-w-[611px] relative z-10">
              ...
              <p className="text-eclipse-gray font-funnel text-lg font-normal leading-[140%] m-0">
                Uma parceria{" "}
                <span className="text-eclipse-purple-light">
                  estratégica para alcançar resultados
                </span>{" "}
                e fortalecer a sua presença digital.
              </p>
